...
public class ShapeMaker {
    ...
    public static Mesh getCube(int x, int y, int z, int w, int h, int l){
        ...
        setArrayRange(2, 3, polys, getFace(x, y + h, z + l, x + w, y + h, z + l, x + w, y, z + l, x, y, z + l)); // back
        setArrayRange(4, 5, polys, getFace(x, y + h, z , x, y + h, z + l, x, y, z + l, x, y, z)); // left
        setArrayRange(6, 7, polys, getFace(x + w, y, z, x + w, y, z + l, x + w, y + h, z + l, x + w, y + h, z)); // right
        setArrayRange(8, 9, polys, getFace(x, y, z + l, x + w, y, z + l, x + w, y, z, x, y, z)); // top
    ...
    public static ArrayList<Polygon> addToArrayList(Mesh mesh, ArrayList<Polygon> list){
        list.addAll(Arrays.asList(mesh.polys));
        return list;
    }
